...
Show available commands for current environment

### Synopsis

Show which commands are available in the current environment based on backend configuration.

```
ags capabilities [flags]
```
